...
## Blank 
![Blank](images/example/blank.png)
...
![Blank](images/example/image_thresholding.png)
## Image Negative
...
```
result processing:
![Blank](images/example/image_negative.png)
## Image Brigtness
...
```
result processing : 
![Blank](images/example/image_brigtness.png)
## Image Rotation
...
![Blank](images/example/image_rotating.png)
## Image Flipping
...
![Blank](images/example/image_flipping.png)
## Image Zooming
...
![Blank](images/example/image_zooming.png)
## Image Shrinking
...
```
result image processing :
![Blank](images/example/image_shringking.png)
...
```
result image processing : 
![Blank](images/example/image_blending.png)
## Image Logarithmic
...
def logarithmic(input_image, coldepth):
    ...
    return output_image
```
![Blank](images/example/image_logarithmic.png)
## Image Translation
...
![Blank](images/example/image_translation.png)
